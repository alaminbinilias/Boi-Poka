      ...
      <div className="mt-15 grid grid-cols-1 mx-2 lg:mx-0 lg:grid-cols-2 gap-10">
        ...
        <div className="mb-20 mx-3 lg:mx-0">
          ...
          <p className="mt-5 text-justify">
            <span className="font-bold">Review:</span> Lorem ipsum dolor, sit
            amet consectetur adipisicing elit. Libero porro vero, optio sequi
            ducimus in quia reprehenderit excepturi corporis voluptatum illum
            minima maiores, esse perferendis repudiandae est commodi dicta
            explicabo! Totam asperiores sequi dolores mollitia dolorem
            repellendus aspernatur fugit ad placeat! Ratione, eum dolor
            doloremque hic dolore vel ad enim quia dolorum nam odit neque
            deserunt amet sequi sint illum! Eveniet ut autem, officia possimus
            ipsa veritatis mollitia nemo molestiae incidunt, doloribus
            dignissimos delectus culpa adipisci soluta, at voluptatum?
            Blanditiis magnam itaque amet aspernatur? Suscipit rem nobis
            obcaecati saepe animi doloribus, recusandae laudantium omnis optio.
            Sed sapiente fuga voluptas reiciendis.
          </p>
          ...
          <div className="flex gap-4 items-center mt-5">
            ...
            <p className="bg-[#f4fcf2] text-[#22bf0a] px-5 py-1 rounded-2xl">
              #Young Adult
            </p>
            <p className="bg-[#f4fcf2] text-[#22bf0a] px-5 py-1 rounded-2xl">
              #Identity
